  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?page=data_barang"><i class="glyphicon glyphicon-tags"></i> <span>Data Barang</span></a></li>
          </ul>
          <ul class="treeview-menu">
            <li><a href="index.php?page=penjualan"><i class="glyphicon glyphicon-tags"></i> <span>Data Penjualan</span></a></li>
          </ul>
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
          <li><a href="index.php?page=transaksi_barang"><i class="glyphicon glyphicon-tags"></i> <span>Single</span></a></li>
          </ul>
          <ul class="treeview-menu">
            <li><a href="index.php?page=data_transaksi_barang"><i class="glyphicon glyphicon-tags"></i> <span>Multi</span></a></li>
          </ul>
      </li>
